...
export default {
  ...
  computed: {
    ...mapState('productionLayoutMes', ['filter', 'lines', 'sublines', 'sublineByline', 'stationBySubline', 'subStationByStation', 'processes', 'selectedLine']),
    showFilter: {
      get() {
        return this.filter;
      },
  ...
  methods: {
    ...
    ...mapMutations('productionLayoutMes', ['setFilter', 'toggleFilter']),
    ...mapActions('productionLayoutMes', ['getfilteredSubline', 'getfilteredStation', 'getfilteredSubStation', 'getSublines', 'getStations', 'getSubStations', 'getProcesses']),
