...
export default {
  ...
  computed: {
    ...mapState('productionLayoutMes', ['sublines', 'selectedLine', 'assets']),
  },
  methods: {
    ...mapMutations('helper', ['setAlert']),
    // ...mapMutations('productionLayoutMes', ['setAddSublineDialog']),
    ...mapActions('productionLayoutMes', ['updateSubline', 'getSublines', 'updateMainLineFlagToSubStations', 'getAssets']),
    // close() {
