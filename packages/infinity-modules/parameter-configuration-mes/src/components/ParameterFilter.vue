...
export default {
  ...
  computed: {
    ...mapState('parameterConfigurationMes', ['filter', 'parameterList', 'lineList', 'sublineList', 'stationList', 'substationList', 'lineValue', 'sublineValue', 'stationValue', 'substationValue', 'directionList', 'categoryList', 'datatypeList', 'selectedParameterName', 'selectedParameterDirection', 'selectedParameterCategory', 'selectedParameterDatatype']),
    showFilter: {
      get() {
        return this.filter;
      },
  ...
  methods: {
    ...mapMutations('parameterConfigurationMes', ['setFilter', 'toggleFilter', 'setApply', 'setLineValue', 'setSublineValue', 'setStationValue', 'setSubstationValue', 'setSelectedParameterName', 'setSelectedParameterDirection', 'setSelectedParameterCategory', 'setSselectedParameterDatatype']),
    ...mapActions('parameterConfigurationMes', ['getParameterListRecords', 'getSublineList', 'getStationList', 'getSubstationList']),
    async btnApply() {
      let query = '?query=';
