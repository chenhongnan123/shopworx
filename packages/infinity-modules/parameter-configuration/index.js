import routes from './src/parameter-configuration-routes';
import store from './src/parameter-configuration-store';
...
export default {
  install(Vue, options) {
    ...
    options.store.registerModule('parameterConfiguration', store);
