...
export default {
  ...
  methods: {
    ...
    ...mapActions('maintenance', ['getCalendarRecords', 'getSublineList', 'getMachineList']),
    async btnApply() {
      let query = '?query=status!="new"';
    ...
    btnReset() {
      this.getCalendarRecords('?query=status!="new"&pagenumber=1&pagesize=10');
      this.toggleCalendarFilter();
      this.type = '';
      this.line = '';
      this.subline = '';
