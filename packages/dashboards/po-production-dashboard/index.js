import routes from './src/production-dashboard-routes';
import store from './src/production-dashboard-store';
...
export default {
  install(Vue, options) {
    ...
    options.store.registerModule('poProductionDashboard', store);
